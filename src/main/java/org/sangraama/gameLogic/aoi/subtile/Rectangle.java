...
public class Rectangle {
    ...
    /**
     * Determine whether this rectangle contains the passed coordination
     *
     * @param x The x coordination of point that might be contained by this rectangle
     * @param y The y coordination of point that might be contained by this rectangle
     * @return true if this rectangle contains the passed rectangle, false if
     *         it does not
     */
     ...
     * Determine whether this rectangle contains the passed coordination
     *
     * @param point The coordination point that might be contained by this rectangle
     * @return true if this rectangle contains the passed rectangle, false if
     *         it does not
     */
