...
public enum UpdateEngine implements Runnable {
	...
	public void setWaitingPlayerList(ArrayList<Player> playerList) {
		/*
		 * if previous updates unable to send to players, ignore current updates
		 * until previous update sent.
		 */
